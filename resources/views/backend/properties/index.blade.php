                        ...
                        <table id="all_properties_list" class="table table-borderless table-striped table-earning" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.show.property', $property->id)}}" data-id="{{$property->id}}" class="view-property item pr-2" data-toggle="tooltip" data-placement="buttom" title="View"><i class="zmdi zmdi-eye" style="font-size:17px;"></i></a>
                                        <a href="{{route('admin.edit.property', $property->id)}}" data-id="{{$property->id}}" class="edit-property item pr-2" data-toggle="tooltip" data-placement="buttom" title="Edit"><i class="zmdi zmdi-edit"></i></a>
