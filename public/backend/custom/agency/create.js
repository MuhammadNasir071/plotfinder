api['updateProfile'] = ajax_path + '/agency/update_profile/:id';
var update_agency_btn = $('#update_agency_btn');

// Update User
$('body').on('submit', '#update_agency_form', function(e){
    e.preventDefault();
    var _this = $(this);
    ...
    button_status(update_agency_btn, true, 'Updating');
    ...
    $.ajax({
        ...
        success: function (response) {
            if (response.responseCode == 200) {
                ...
                setTimeout(function () {
                    button_status(update_agency_btn, false);
